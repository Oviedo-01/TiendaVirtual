...
public class SubPanelCarrito extends javax.swing.JPanel {
    ...
    // ========== MÉTODOS PARA CARGAR Y MOSTRAR CARRITO ==========
    ...
    private void cargarCarrito() {
        ...
        if (items.isEmpty()) {
            ...
            javax.swing.JLabel lblVacio = new javax.swing.JLabel("Tu carrito está vacío");
    ...
    private javax.swing.JPanel crearPanelControles(modelo.entidades.ItemCarrito item, int indice) {
        ...
        javax.swing.SpinnerNumberModel modeloSpinner = new javax.swing.SpinnerNumberModel(
            ...
            1,                   // mínimo
            item.getProducto().getStock(),  // máximo (stock disponible)
            1                    // step
        );
    ...
    private void finalizarCompra() {
        if (carritoManager.estaVacio()) {
            javax.swing.JOptionPane.showMessageDialog(
                this,
                "Tu carrito está vacío. Agrega productos para comprar.",
                "Carrito vacío",
                javax.swing.JOptionPane.WARNING_MESSAGE
            );
            return;

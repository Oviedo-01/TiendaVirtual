...
public class SubPanelHistorial extends javax.swing.JPanel {
    ...
    // ========== MÉTODOS PARA CARGAR Y MOSTRAR HISTORIAL ==========
    ...
    private void cargarHistorial() {
        ...
        if (compras.isEmpty()) {
            ...
            javax.swing.JLabel lblVacio = new javax.swing.JLabel("No has realizado compras aún");
            ...
            // Crear tarjetas para cada compra (de más reciente a más antigua)
            // Las compras en la cola están en orden cronológico (FIFO)
            // Mostramos en orden inverso para ver las más recientes primero
    ...
    private String formatearFecha(String fecha) {
        ...
        // La convertimos a formato más legible: dd/MM/yyyy
        try {
